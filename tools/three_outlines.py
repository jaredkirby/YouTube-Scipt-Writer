...
def get_outlines(chat, outlines_input: str):
    ...
    and outlines for the following video title: 
    ...
    Use visual aids, personal stories, narrative arcs and metaphors to illustrate your points sustainably. Share case 
    studies of successful DIY entrepreneurs, and involve your viewers through interactive elements and regular calls to 
    action. Create emotional connections by incorporating humor, passion, excitement, and shared experiences. 
    Keep your content simple, clear, and jargon-free, while maintaining high production quality. Reinforce key points 
    through consistency and repetition. Additionally, keep your audience engaged with cliffhangers and teasers for future 
    videos. Finally, enrich your content with expert testimonials when applicable to expand your credibility.

    Remember you are to apply this information and techniques to creating video descriptions and outlines for only the 
    following title and topic: 

    --- 
    {outlines_input}
    --- 

    Respond with 3 detailed video descriptions and outline options for the the video content.
    '''
    ...
    formatted_prompt = chat_prompt.format_prompt(outlines_input=outlines_input).to_messages()
    llm = chat
